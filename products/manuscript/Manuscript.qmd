...
Temporal analysis was first visualized using

conducted using poisson regression. All machine learning models were conducted using the tidymodels workflow. Specific packages for poisson modeling were parsnip and poissonreg.
...
The first goal of this analysis is to find any seasonal patterns in *Listeria* infections and *Listeria* contaminated food items. In figure 5 we can see that cases of listeriosis typically dip around the 100th day of the year which is early April, and spikes near the 200th to 300th days of the year which are mid July to late October. The prediction model forecasts low counts of Listeriosis from the end of 2023 to earlt 2024
