...
# Plot
seasonalpreds <- ggplot(combined_data, aes(x = month, y = clinical_count, color = source)) +
  geom_line() +
...
plot(gam_model)
ggsave("/Users/alexisgonzalez/Desktop/MADA/Gonzalez-MADA-project/results/figures/gam_model.png", plot = gam_model, width = 8, height = 6, dpi = 300)
```
